...
public class DocumentUBLServiceImpl implements DocumentUBLService{
	...
	public String generarFormatoFactura(Factura factura) {
        ...
        try {
            ...
            log.info("inicio: generar factura paso 4. Tipo de Operación.");
            ...
            ProfileID.setAttribute("schemeAgencyName", "urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo17");
            ProfileID.appendChild(doc.createTextNode("0101"));
            ...
            IssueDate.appendChild(doc.createTextNode(factura.getFechaEmision()));
            ...
            IssueTime.appendChild(doc.createTextNode(factura.getHoraEmision()));
            ...
            LegendIdSW.appendChild(doc.createTextNode(factura.getId()));
            ...
            cdata = doc.createCDATASection(factura.getRazonSocial());
            ...
            CompanyID.appendChild(doc.createTextNode(factura.getRuc()));
            ...
            CompanyIDCustomer.appendChild(doc.createTextNode(factura.getRucCliente()));
            ...
            cdata = doc.createCDATASection(factura.getRazonSocialCliente());
